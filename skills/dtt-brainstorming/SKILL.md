...
Use this skill to deepen requirement discovery without replacing pack workflow routing.
...
- produce a short design summary that can feed `dtt-writing-plans`
...
- design summary suitable for planning
